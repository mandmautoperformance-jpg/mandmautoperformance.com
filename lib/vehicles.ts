...
import { exteriorsFor, detectColor, detectVariant, hashId } from './vehicle-photos';
...
const BASE_MODELS: BaseModel[] = [
  ...
  { key: 'range-rover-sport', make: 'Land Rover', model: 'Range Rover Sport', category: 'suv', specs: { horsepower: 523, acceleration: '4.3s', topSpeed: 162, transmission: 'Automatic' }, daily: 400, hourly: 70, features: ['Terrain Response', 'Meridian Audio', 'Air Suspension', 'Panoramic Roof', 'Heated Seats', 'Apple CarPlay'], description: 'Commanding presence with first-class comfort. The luxury SUV benchmark.', weight: 3 },
  ...
  { key: 'bugatti-chiron', make: 'Bugatti', model: 'Bugatti Chiron', category: 'exotic', specs: { horsepower: 1479, acceleration: '2.4s', topSpeed: 261, transmission: 'Automatic' }, daily: 5000, hourly: 800, features: ['Quad-Turbo W16', 'Carbon Monocoque', 'Active Aero Wing', 'Acculine Audio', 'Telemetry Laptimer', 'Speed Key'], description: 'The 1,479hp quad-turbo W16 hypercar. The ultimate expression of automotive engineering, bar none.', weight: 1 },
  { key: 'bugatti-veyron', make: 'Bugatti', model: 'Bugatti Veyron', category: 'exotic', specs: { horsepower: 1001, acceleration: '2.5s', topSpeed: 253, transmission: 'Automatic' }, daily: 4200, hourly: 680, features: ['Quad-Turbo W16', 'Permanent AWD', 'Hydraulic Rear Wing', 'Puccini Audio', 'Carbon Bodywork', 'Top Speed Key'], description: 'The legend that redefined the hypercar. The first 1,000hp production car to break 250mph.', weight: 1 },
  ...
  // ---- Performance SUVs ----
  { key: 'aston-dbx707', make: 'Aston Martin', model: 'Aston Martin DBX707', category: 'suv', specs: { horsepower: 697, acceleration: '3.1s', topSpeed: 193, transmission: 'Automatic' }, daily: 850, hourly: 130, features: ['707hp Twin-Turbo V8', 'Wet Brakes', 'Air Suspension', 'Body & Optics Pack', 'Massage Seats', 'Sport Exhaust'], description: 'The world’s most powerful luxury SUV. A 697hp Aston that corners like a sports car.', weight: 2 },
  { key: 'ferrari-purosangue', make: 'Ferrari', model: 'Ferrari Purosangue', category: 'suv', specs: { horsepower: 715, acceleration: '3.3s', topSpeed: 193, transmission: 'Automatic' }, daily: 1900, hourly: 290, features: ['Naturally Aspirated V12', 'Active Suspension', 'Welcome Doors', 'Burmester Audio', 'Carbon Roof', 'Four-Wheel Drive'], description: 'Ferrari’s first four-door. A V12 super-SUV that refuses to compromise on driving thrill.', weight: 1 },
  { key: 'lambo-urus', make: 'Lamborghini', model: 'Lamborghini Urus', category: 'suv', specs: { horsepower: 657, acceleration: '3.5s', topSpeed: 190, transmission: 'Automatic' }, daily: 1300, hourly: 200, features: ['ANIMA Drive Modes', 'Carbon Ceramic Brakes', 'Bang & Olufsen Audio', 'Air Suspension', 'Panoramic Roof', 'Massage Seats'], description: 'The original super-SUV. Supercar pace and presence with five-seat practicality.', weight: 2 },
  { key: 'audi-rsq8', make: 'Audi', model: 'Audi RS Q8', category: 'suv', specs: { horsepower: 591, acceleration: '3.7s', topSpeed: 190, transmission: 'Automatic' }, daily: 550, hourly: 90, features: ['Quattro AWD', 'Twin-Turbo V8', 'Bang & Olufsen 3D Audio', 'Air Suspension', 'Virtual Cockpit', 'Sport Differential'], description: 'A Lamborghini Urus in a sharp suit. 591hp of understated, all-weather super-SUV.', weight: 1 },
  { key: 'bmw-xm', make: 'BMW', model: 'BMW XM', category: 'suv', specs: { horsepower: 644, acceleration: '4.1s', topSpeed: 168, transmission: 'Automatic' }, daily: 600, hourly: 95, features: ['V8 Plug-in Hybrid', 'M xDrive AWD', 'Bowers & Wilkins Audio', 'Curved Display', 'Merino Leather', 'Air Suspension'], description: 'BMW M’s wild hybrid flagship. 644hp, theatrical design and a properly luxurious cabin.', weight: 1 },
  { key: 'porsche-cayenne', make: 'Porsche', model: 'Porsche Cayenne Turbo GT', category: 'suv', specs: { horsepower: 631, acceleration: '3.3s', topSpeed: 186, transmission: 'Automatic' }, daily: 600, hourly: 100, features: ['Sport Chrono', 'Burmester Audio', 'Air Suspension', 'Carbon Package', 'Panoramic Roof', 'Sport Exhaust'], description: 'The fastest SUV Porsche has ever built. A track weapon that seats the whole family.', weight: 1 },
  { key: 'merc-gle63', make: 'Mercedes-AMG', model: 'Mercedes-AMG GLE 63 S', category: 'suv', specs: { horsepower: 603, acceleration: '3.8s', topSpeed: 174, transmission: 'Automatic' }, daily: 550, hourly: 90, features: ['AMG 4MATIC+', 'EQ Boost', 'Burmester Audio', 'Air Suspension', 'Massage Seats', 'Night Package'], description: 'A 603hp twin-turbo V8 family hauler. AMG muscle wrapped in everyday SUV comfort.', weight: 1 },
  { key: 'rolls-cullinan', make: 'Rolls-Royce', model: 'Rolls-Royce Cullinan', category: 'suv', specs: { horsepower: 563, acceleration: '4.9s', topSpeed: 155, transmission: 'Automatic' }, daily: 1500, hourly: 230, features: ['Starlight Headliner', 'Bespoke Audio', 'Viewing Suite', 'Massage Seats', 'Lambswool Rugs', 'Coach Doors'], description: 'The most luxurious SUV on earth. A magic-carpet ride wrapped in handcrafted opulence.', weight: 1 },
  { key: 'bentley-bentayga', make: 'Bentley', model: 'Bentley Bentayga', category: 'suv', specs: { horsepower: 542, acceleration: '4.4s', topSpeed: 180, transmission: 'Automatic' }, daily: 700, hourly: 120, features: ['Naim Audio', 'Air Suspension', 'Heated/Cooled Seats', 'Mood Lighting', 'Panoramic Roof', 'Diamond Quilting'], description: 'Britain’s handcrafted luxury SUV. Limousine comfort with genuine performance.', weight: 1 },
  { key: 'amg-g63', make: 'Mercedes-AMG', model: 'Mercedes-AMG G63', category: 'suv', specs: { horsepower: 577, acceleration: '4.5s', topSpeed: 137, transmission: 'Automatic' }, daily: 800, hourly: 130, features: ['AMG 4MATIC', 'Burmester Audio', 'Nappa Leather', 'AMG Ride Control', 'Heated/Cooled Seats', 'Off-Road Pack'], description: 'The icon. Hand-built AMG V8 muscle in the most recognisable shape on the road.', weight: 2 },
...
function generateFleet(): Vehicle[] {
  ...
  BASE_MODELS.forEach((base, modelIdx) => {
    ...
    const numColors = 2;
    // Labels (colour OR body/edition) already taken by THIS model's earlier car,
    // so the two cars of a model never share a descriptor when the pool allows.
    const modelLabels = new Set<string>();
    // The descriptor a given photo would carry: paint colour first, else a body/
    // edition variant — both read honestly from the filename.
    const labelOf = (url: string): string | null =>
      detectColor(url)?.name ?? detectVariant(url, base.model);

    for (let i = 0; i < numColors; i++) {
      // Offset start per model so the palette is varied across categories.
      const colorIdx = (modelIdx * 7 + i) % PALETTE.length;
      ...
      // model's exterior pool in a per-car seeded order, then choose by priority:
      //   1. unused photo whose descriptor (colour OR body/edition) is NEW to
      //      this model — so the two cars never read the same
      //   2. unused photo with no descriptor at all ("As pictured")
      //   3. any unused photo (last-resort)
      //   4. the seeded image if the pool is exhausted
      // This guarantees the two cars of a model look different AND, whenever the
      // pool allows, carry different colour/trim labels — without ever asserting
      // a colour that contradicts the picture.
      ...
      if (exterior.length) {
        ...
        heroPhoto =
          ordered.find((u) => {
            if (usedPhotos.has(u)) return false;
            const label = labelOf(u);
            return label !== null && !modelLabels.has(label);
          }) ||
          ordered.find((u) => !usedPhotos.has(u) && labelOf(u) === null) ||
          ordered.find((u) => !usedPhotos.has(u)) ||
          ordered[0];
        usedPhotos.add(heroPhoto);
      }

      // The advertised label MUST match the photo we actually show. Read paint
      // colour straight from the pinned hero photo (with a swatch); when no
      // colour is named, fall back to an honest body/edition descriptor read
      // from the same photo; only then to a non-committal "As pictured". We
      // never assert a colour that contradicts the picture. The slug keeps its
      // palette name so URLs stay stable.
      const detected = heroPhoto ? detectColor(heroPhoto) : null;
      const variant = heroPhoto && !detected ? detectVariant(heroPhoto, base.model) : null;
      const displayColor = detected ?? { name: variant ?? 'As pictured', hex: '' };
      const heroLabel = heroPhoto ? labelOf(heroPhoto) : null;
      if (heroLabel) modelLabels.add(heroLabel);
