...
import { Shield, Zap, Award, MapPin, Users, Car } from 'lucide-react';
        ...
        <section className="relative px-4 sm:px-6 lg:px-8 pt-24 pb-20 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-performance-turquoise/10 border border-performance-turquoise/30 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-performance-turquoise">Part of the RichHabits Ecosystem</span>
            </div>
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              M&M Auto Performance is the UK's most advanced vehicle hire platform — combining elite cars with AI-powered booking and a rewards system that actually respects your time.
            </p>
          </div>
        </section>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-16 border-t border-performance-turquoise/10">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { icon: <Shield size={28} className="text-performance-turquoise" />, title: 'Trust & Transparency', desc: 'Every price is shown upfront. No hidden fees, no surprises. Our AI verification system protects both drivers and vehicles.' },
                { icon: <Zap size={28} className="text-performance-turquoise" />, title: 'Speed & Efficiency', desc: 'Real-time availability, sub-2-minute document processing, and instant booking confirmation. We respect your time.' },
                { icon: <Award size={28} className="text-performance-turquoise" />, title: 'Rewarding Loyalty', desc: 'The Driver\'s Passport rewards disciplined, consistent drivers. The better your habits, the better your benefits.' },
              ].map((item, i) => (
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['St Albans', 'Watford', 'Hemel Hempstead', 'Harpenden', 'Luton', 'Mayfair', 'Chelsea', 'Canary Wharf', 'Shoreditch', 'Hampstead'].map((loc) => (
                <span key={loc} className="flex items-center gap-1.5 px-4 py-2 bg-performance-turquoise/10 border border-performance-turquoise/30 rounded-full text-sm text-performance-turquoise">
                  <MapPin size={12} /> {loc}
                </span>
              ))}
            </div>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 border-t border-performance-turquoise/10 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/fleet" className="px-8 py-4 bg-performance-turquoise text-performance-grey font-bold rounded-lg hover:bg-performance-turquoise/90 transition-all">
                Browse Fleet
              </Link>
              <Link href="/contact" className="px-8 py-4 border-2 border-performance-turquoise text-performance-turquoise font-bold rounded-lg hover:bg-performance-turquoise/10 transition-all">
                Get in Touch
              </Link>
            </div>
          </div>
