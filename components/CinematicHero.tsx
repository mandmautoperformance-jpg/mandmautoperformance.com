...
// Swap this path for /hero-bg.jpg once the branded image is uploaded to public/
const BG_URL =
  ...
  return (
    <section
      ...
      style={{
        ...
        // rest of the page scrolls over it — the signature parallax feel.
        backgroundAttachment: 'fixed',
      }}
    >
      {/* Layered dark overlays for the moody, cinematic look */}
      <div className="absolute inset-0 bg-black/62" />
      <div className="absolute inset-0 bg-gradient-to-t from-black via-black/35 to-transparent" />
      <div className="absolute inset-0 bg-gradient-to-r from-black/30 via-transparent to-black/30" />

      {/* Content — anchored to the bottom third, matching the reference design */}
      <div className="relative h-full flex flex-col items-center justify-end text-center pb-28 px-6">
        {/* Eyebrow */}
        ...
        {/* Main headline */}
        <h1 className="font-display text-5xl sm:text-6xl lg:text-[5.5rem] font-bold text-white mb-6 leading-[1.05] tracking-tight">
          Rent luxury car<br className="hidden sm:block" /> in London
        </h1>

        {/* Sub-copy */}
        <p className="text-white/65 text-base sm:text-lg max-w-xl mx-auto mb-12 leading-relaxed">
