...
export const Hero: React.FC<HeroProps> = ({
  ...
  subtitle = 'Experience high-performance automotive luxury across London & Hertfordshire. Real-time booking. AI-verified. Habit Scored.',
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-performance-turquoise to-performance-babyblue text-performance-grey font-bold rounded-lg overflow-hidden transition-all duration-300 transform hover:scale-105 hover:shadow-2xl"
          >
          ...
          <Link
            ...
            className="px-8 py-4 border-2 border-performance-turquoise text-performance-turquoise hover:bg-performance-turquoise/10 font-bold rounded-lg transition-all duration-300"
          >
            {secondaryCTA.text}
          </Link>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 mt-20 pt-12 border-t border-performance-turquoise/20">
          <div className="text-center">
            <div className="text-3xl sm:text-4xl font-bold text-performance-turquoise">
              500+
            </div>
            <p className="text-gray-400 text-sm mt-2">Premium Vehicles</p>
          </div>
          <div className="text-center">
            <div className="text-3xl sm:text-4xl font-bold text-performance-babyblue">
              24/7
            </div>
